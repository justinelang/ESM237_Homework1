...
```{r setup, INCLUDE = FALSE, echo = TRUE, warning = FALSE, message = FALSE, results = FALSE}
...
clim = read_csv(here("belhaven.csv"))
head(clim)
```
...
fillrow = which(is.na(clim$TMAX) | clim$TMAX < 5)
...
summary(res)
confint(res,"dt", level=0.95)
ggplot(clim.mwy, aes(x=dt, y=tmax)) + stat_summary(fun.y="mean", geom="point", col="red", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()
```
...
```{r}
res=lm(precip~dt, data=clim.mwy)
summary(res)
confint(res,"dt", level=0.95)
ggplot(clim.mwy, aes(x=dt, y=precip)) + stat_summary(fun.y="sum", geom="point", col="blue", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()
```
...
# early portion
res_early=lm(tmax~dt, data=subset(clim.mwy, clim.mwy$dt %in% c(1970:1990)))
summary(res_early)
confint(res_early,"dt", level=0.90)
ggplot(subset(clim.mwy, clim.mwy$dt %in% c(1970:1990)), aes(x=dt, y=tmax)) + stat_summary(fun.y="mean", geom="point", col="red", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()

# last decade
res_late=lm(tmax~dt, data=subset(clim.mwy, clim.mwy$dt %in% c(2002:2022)))
summary(res_late)
confint(res_late,"dt", level=0.90)
ggplot(subset(clim.mwy, clim.mwy$dt %in% c(2002:2022)), aes(x=dt, y=tmax)) + stat_summary(fun.y="mean", geom="point", col="red", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()
...
```{r}
# early portion
res_early=lm(precip~dt, data=subset(clim.mwy, clim.mwy$dt %in% c(1970:1990)))
summary(res_early)
confint(res_early,"dt", level=0.90)
ggplot(subset(clim.mwy, clim.mwy$dt %in% c(1970:1990)), aes(x=dt, y=precip)) + stat_summary(fun.y="sum", geom="point", col="blue", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()

# last decade
res_late=lm(precip~dt, data=subset(clim.mwy, clim.mwy$dt %in% c(2002:2022)))
summary(res_late)
confint(res_late,"dt", level=0.90)
ggplot(subset(clim.mwy, clim.mwy$dt %in% c(2002:2022)), aes(x=dt, y=precip)) + stat_summary(fun.y="sum", geom="point", col="blue", size=4)+theme(axis.text=element_text(size=14, face="bold"), axis.title=element_text(size=14, face="bold")) + geom_smooth(method="lm") + theme_minimal()
```
...
t.test(subset(clim.mwy$tmin, clim.mwy$dt %in% 1975:1985), subset(clim.mwy$tmin, clim.mwy$dt %in% 2002:2022))

wilcox.test(subset(clim.mwy$tmin, clim.mwy$dt %in% 1975:1985), subset(clim.mwy$tmin, clim.mwy$dt %in% 2002:2022))
